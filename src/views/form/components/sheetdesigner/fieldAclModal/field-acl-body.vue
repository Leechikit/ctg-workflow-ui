<template>
    <div class="col-left col-sm-12" style="height:390px">
        <table class="table table-hover table-title">
            <thead>
                <tr>
                    <th style="width:178px">字段</th>
                    <th v-for="(column, index) in columns" :key="index" style="width:140px">
                        <div class="ckbox ckbox-default">
                            ...
                            <label 
                                ...
                                @click="checkAllHandler(column.columnName)">{{column.text}}</label>
                        </div>
                    </th>
                </tr>
            </thead>
        </table>
        <div style="max-height:352px; overflow:scroll;">
            <table class="table table-hover table-body" :class="'table-' + prefix ">
                <tbody>
                    <tr v-for="(value, fieldKey) in properties" 
                        v-if="defaultRowNames.indexOf(fieldKey) < 0 && fieldKey != 'PrintComment'" 
                        :key="fieldKey">
                        <td style="width:178px;">{{ value }}</td>
