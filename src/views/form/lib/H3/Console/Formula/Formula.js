                ...
                if (NextChar == '"') {
                    ...
                    if (CloseVaribleIndex > -1) {
                        ...
                        if (varibleText) {
                            ...
                            if (true || (window.navigator.userAgent.indexOf("MSIE") > -1 || window.navigator.userAgent.indexOf("rv:11") > -1) && (window.navigator.userAgent.indexOf("Opera") < 0)) {
                                //IE用canvas
...
function getNodeId(treeNode) {
    ...
    if (parentId.length > 0 && parentId != SchemaCode) {
