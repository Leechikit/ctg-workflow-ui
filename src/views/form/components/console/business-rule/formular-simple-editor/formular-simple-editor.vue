    ...
    export default {
        ...
        methods: {
            ...
            initCurrentSheetFieldsRootNode: function(){
                ...
                this.loadAppTreeNodes(that.currentSheetCode, that.currentSheetCode, "AppMenu")
                    .then(function(children){
                        var convertedNodes = that.convertToTreeViewNodes(children, that.currentSheetFieldsRootNode);
            ...
            treeViewNodeClickHandler(checkedNode){
                ...
                this.loadAppTreeNodes(checkedNode.ObjectId, checkedNode.Code, nodeType)
                    .then(function(children){
                        ...
                        var convertedNodes = that.convertToTreeViewNodes(children, that.targetSheetFieldsRootNode);
            ...
            async getValidateMessage(sheetCode, expression, formulaType, formulaField){
                ...
                let validateInfo = await this.validateFomula(sheetCode, expression, formulaType, formulaField);
                if(!validateInfo){
            ...
            async validateFomula(sheetCode, formula, formulaType, formulaField){
            ...
            async loadAppTreeNodes(id, code, nodeType){
                ...
                var settings = Object.assign({}, params, this.appTreeSettings, params)
