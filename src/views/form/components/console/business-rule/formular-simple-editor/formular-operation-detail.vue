<template>
    <div>
        <Row id="filterItemWrapper" v-if="operationOption && operationOption.showOperationRange">
            <div  class="title">
        ...
        <Row id="operationItemWrapper" v-if="operationOption && operationOption.showConcretOperation">
            ...
            <div v-if="operationOption.operateFileAttachment">
            ...
            <div v-else class="operation-item" 
