...
export const WorkflowDocument = {
    ...
    PublishWorkflow: function () {
        ...
        HTTP.saveFlow(WorkflowDocument.GetWorkflowPostData('PublishWorkflow', true))
                .then(result => {
                if (result.code==0) {
                    var successMsg = '';
                    var errorMsg = '';
        ...
        // PostAction('PublishWorkflow', WorkflowDocument.GetWorkflowPostData('PublishWorkflow', true), function (result) {
        //     if (result.Successful) {
        //         result = result.ReturnData.Data;
        //         var _Content = [];
        ...
        // }, function () {
        //     WorkflowDocument.ShowAjaxErrors(msg, '发布失败');
        // });
